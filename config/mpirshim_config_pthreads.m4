...
dnl $HEADER$
dnl
dnl MPIRSHIM_CONFIG_POSIX_THREADS()
dnl
...
# ********************************************************************
#
# Internal macros - do not call from outside MPIRSHIM_CONFIG_POSIX_THREADS
#
# ********************************************************************


AC_DEFUN([MPIRSHIM_INTL_PTHREAD_TRY_LINK], [
# BEGIN: MPIRSHIM_INTL_PTHREAD_TRY_LINK
#
...
int main(int argc, char* argv[])
{
    ...
    return 0;
                 ...
                 [$1], [$2])
# END: MPIRSHIM_INTL_PTHREAD_TRY_LINK
])dnl
...
#
# ********************************************************************
AC_DEFUN([MPIRSHIM_INTL_POSIX_THREADS_PLAIN_C], [
#
# C compiler
#
if test "$mpirshim_pthread_c_success" = "0"; then
  AC_MSG_CHECKING([if C compiler and POSIX threads work as is])

  AC_LANG_PUSH(C)
  MPIRSHIM_INTL_PTHREAD_TRY_LINK(mpirshim_pthread_c_success=1,
                            mpirshim_pthread_c_success=0)
  AC_LANG_POP(C)
  if test "$mpirshim_pthread_c_success" = "1"; then
    AC_MSG_RESULT([yes])
  else
    AC_MSG_RESULT([no])
  fi
...
AC_DEFUN([MPIRSHIM_INTL_POSIX_THREADS_PLAIN_CXX], [
#
# C++ compiler
#
if test "$mpirshim_pthread_cxx_success" = "0"; then
  AC_MSG_CHECKING([if C++ compiler and POSIX threads work as is])

  AC_LANG_PUSH(C++)
  MPIRSHIM_INTL_PTHREAD_TRY_LINK(mpirshim_pthread_cxx_success=1,
                            mpirshim_pthread_cxx_success=0)
  AC_LANG_POP(C++)
  if test "$mpirshim_pthread_cxx_success" = "1"; then
    AC_MSG_RESULT([yes])
  else
    AC_MSG_RESULT([no])
  fi
...
AC_DEFUN([MPIRSHIM_INTL_POSIX_THREADS_PLAIN], [
# BEGIN: MPIRSHIM_INTL_POSIX_THREADS_PLAIN
#
...
AC_PROVIDE_IFELSE([AC_PROG_CC],
                  [MPIRSHIM_INTL_POSIX_THREADS_PLAIN_C],
                  [mpirshim_pthread_c_success=1])

AC_PROVIDE_IFELSE([AC_PROG_CXX],
                  [MPIRSHIM_INTL_POSIX_THREADS_PLAIN_CXX],
                  [mpirshim_pthread_cxx_success=1])

# End: MPIRSHIM_INTL_POSIX_THREADS_PLAIN
])dnl
...
#
# ********************************************************************
AC_DEFUN([MPIRSHIM_INTL_POSIX_THREADS_SPECIAL_FLAGS_C], [
#
# C compiler
#
if test "$mpirshim_pthread_c_success" = "0"; then
...
AC_DEFUN([MPIRSHIM_INTL_POSIX_THREADS_SPECIAL_FLAGS_CXX], [
#
# C++ compiler
#
if test "$mpirshim_pthread_cxx_success" = "0"; then
...
AC_DEFUN([MPIRSHIM_INTL_POSIX_THREADS_SPECIAL_FLAGS],[
# Begin: MPIRSHIM_INTL_POSIX_THREADS_SPECIAL_FLAGS
#
...
AC_PROVIDE_IFELSE([AC_PROG_CC],
                  [MPIRSHIM_INTL_POSIX_THREADS_SPECIAL_FLAGS_C],
                  [mpirshim_pthread_c_success=1])

AC_PROVIDE_IFELSE([AC_PROG_CXX],
                  [MPIRSHIM_INTL_POSIX_THREADS_SPECIAL_FLAGS_CXX],
                  [mpirshim_pthread_cxx_success=1])

# End: MPIRSHIM_INTL_POSIX_THREADS_SPECIAL_FLAGS
])dnl
...
#
# ********************************************************************
AC_DEFUN([MPIRSHIM_INTL_POSIX_THREADS_LIBS_C],[
#
# C compiler
#
if test "$mpirshim_pthread_c_success" = "0"; then
...
AC_DEFUN([MPIRSHIM_INTL_POSIX_THREADS_LIBS_CXX],[
#
# C++ compiler
#
if test "$mpirshim_pthread_cxx_success" = "0"; then
  if test ! "$mpirshim_pthread_c_success" = "0" && test ! "$PTHREAD_LIBS" = "" ; then
...
AC_DEFUN([MPIRSHIM_INTL_POSIX_THREADS_LIBS],[
# Begin: MPIRSHIM_INTL_POSIX_THREADS_LIBS
#
...
# Only run C++ and Fortran if those compilers already configured
AC_PROVIDE_IFELSE([AC_PROG_CC],
                  [MPIRSHIM_INTL_POSIX_THREADS_LIBS_C],
                  [mpirshim_pthread_c_success=1])

AC_PROVIDE_IFELSE([AC_PROG_CXX],
                  [MPIRSHIM_INTL_POSIX_THREADS_LIBS_CXX],
                  [mpirshim_pthread_cxx_success=1])

# End: MPIRSHIM_INTL_POSIX_THREADS_LIBS]
)dnl
...
#
#********************************************************************
AC_DEFUN([MPIRSHIM_CONFIG_POSIX_THREADS],[
...
MPIRSHIM_INTL_POSIX_THREADS_PLAIN

# Try the super-special compiler flags.
MPIRSHIM_INTL_POSIX_THREADS_SPECIAL_FLAGS

# Try the normal linking methods (that's no fun)
MPIRSHIM_INTL_POSIX_THREADS_LIBS
...
AC_DEFINE_UNQUOTED([MPIRSHIM_HAVE_PTHREAD_MUTEX_ERRORCHECK_NP], [$defval],
...
AC_LINK_IFELSE(
    ...
    [result="yes" defval=1], [result="no" defval=0])
AC_MSG_RESULT([$result])
AC_DEFINE_UNQUOTED([MPIRSHIM_HAVE_PTHREAD_MUTEX_ERRORCHECK], [$defval],
...
if test "$mpirshim_pthread_c_success" = "1" && \
   test "$mpirshim_pthread_cxx_success" = "1"; then
  internal_useless=1
  $1
else
  internal_useless=1
...
unset mpirshim_pthread_c_success mpirshim_pthread_cxx_success
