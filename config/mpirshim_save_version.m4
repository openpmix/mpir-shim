...
# MPIRSHIM_SAVE_VERSION(project_short, project-long,
#                  version_file, header_file])
# ----------------------------------------------
# creates version information for project from version_file, using
# MPIRSHIM_GET_VERSION().  Information is AC_SUBSTed and put in
# header_file.
AC_DEFUN([MPIRSHIM_SAVE_VERSION], [
    MPIRSHIM_GET_VERSION([$3], [$1])
