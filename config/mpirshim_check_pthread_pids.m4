...
AC_DEFUN([MPIRSHIM_CHECK_PTHREAD_PIDS],[
#
# Arguments: none
#
# Dependencies: None
#
# Sets:
#  MPIRSHIM_THREADS_HAVE_DIFFERENT_PIDS (variable)
#
# Test for Linux-like threads in the system.  MPIRSHIM does not support
...
MPIRSHIM_VAR_SCOPE_PUSH([tpids_CFLAGS_save tpids_CPPFLAGS_save tpids_LDFLAGS_save tpids_LIBS_save tpids_MSG])
...
[tpids_MSG=no MPIRSHIM_THREADS_HAVE_DIFFERENT_PIDS=0],
[tpids_MSG=yes MPIRSHIM_THREADS_HAVE_DIFFERENT_PIDS=1],
[
 ...
 MPIRSHIM_THREADS_HAVE_DIFFERENT_PIDS=
...
AS_IF([test "x$MPIRSHIM_THREADS_HAVE_DIFFERENT_PIDS" = "x"],
      [ # If we are cross-compiling, look for the symbol
       ...
       AC_CHECK_FUNC([__linuxthreads_create_event],
                     [MPIRSHIM_THREADS_HAVE_DIFFERENT_PIDS=1])])

AS_IF([test "$MPIRSHIM_THREADS_HAVE_DIFFERENT_PIDS" = "1"],
