...
AC_DEFUN([MPIRSHIM_CHECK_ICC_VARARGS],[
dnl
...
],[mpirshim_ac_icc_varargs=`test -f conftestval`],[mpirshim_ac_icc_varargs=1],[mpirshim_ac_icc_varargs=1])

if test "$mpirshim_ac_icc_varargs" = "1"; then
